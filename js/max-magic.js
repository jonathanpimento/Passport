(function() {
    ...
    var colors = ['215,69,47', '201,30,72', '240,157,192', '150,25,41', '237,45,109'];
    ...
    function tweenTriangle(tri) {
        ...
        var x = (400+Math.random()*100)*Math.cos(t) + width*0.5;
    ...
    function scrollCheck() {
        console.log(document.body.scrollTop + " " + height);
    ...
    function animate() {
        console.log("Animate header" + animateHeader);
        if(animateHeader) {
    ...
    function Triangle() {
        ...
        function init() {
            ...
            _this.pos.z = height*0.5-60;
            _this.coords[0].x = -10+Math.random()*20;
            _this.coords[0].y = -10+Math.random()*40;
            _this.coords[0].z = -10+Math.random()*60;
        ...
        this.draw = function() {
            if(_this.alpha >= 0.05) _this.alpha -= 0.005;
            else _this.alpha = 0.8;
            ctx.beginPath();
